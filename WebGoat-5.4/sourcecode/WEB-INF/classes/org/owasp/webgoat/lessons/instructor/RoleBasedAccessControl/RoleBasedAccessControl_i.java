...
Repeat stage 1 and note that the function fails with a "Not authorized" message.
 ...
 Adding the access check in the RoleBasedAccessControl:handleRequest() is putting the check in the 揅ontroller? The access check can also be added to DeleteProfile.deleteEmployeeProfile(), which is putting the check in the 揃usiness Function?*/
